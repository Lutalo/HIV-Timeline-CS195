function navHighlight()
{
    ...
    if (active === "")
    {
        ...
        document.getElementById("home").style.borderTop = "2px solid #4B90E0";
    }
    ...
    else if (active == "support" || active == "testing")
    {
        ...
        document.getElementById("services").style.borderTop = "2px solid #4B90E0";
    }

    else if (active == "aboutHIV" || active == "prevention" || active == "videos")
    {
        document.getElementById("information").style.borderTop = "2px solid #4B90E0";
